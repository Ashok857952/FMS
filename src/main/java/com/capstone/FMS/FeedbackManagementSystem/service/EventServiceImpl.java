...
public class EventServiceImpl implements EventService {
	...
	public Flux<Event> getAllEventList() {
		Flux<Event> events = eventRep.findAll();
		return events;
	}

	@Override
	public Flux<Event> searchEventsById(String eventId) {
		return eventRep.findAllByEvent_id(eventId);
	}

	@Override
	public Flux<Event> searchEventsByVH(int volunteerHours) {
		return eventRep.findAllByVolunteer_hours(volunteerHours);
	}
	...
	public void generateExcel() {
		Flux<Event> values = eventRep.findAll();
